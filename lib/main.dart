...
import 'package:ugly_santa/mainProduct.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ugly Santa'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _product() {
        ...
        MaterialPageRoute(builder: (context) => const MyAppProduct()));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
         ...
         Image.network("https://drive.google.com/uc?export=view&id=1BlfDTDXZj4YvBK_mhMx3oHAyxTUoFVNS",    
          ...
          const Text('"Quand le bon goût est surcoté"',
                style: TextStyle(
     ...
     bottomNavigationBar:BottomNavigationBar(
        ...
        onTap: (value){
          if (value == 0) _incrementTab(value);
          if (value == 1) _product();
